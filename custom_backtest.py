...
def run_backtest(symbol, start, end, strategy_json, cash=10000, interval='1d'):
    ...
    Returns:
    - HTML content as a string for visualization
    """
    try:
        ...
        # Use the built-in plot method to generate the visualization HTML
        # Check what parameters are accepted by exploring the method
        try:
